...
o	Data Layer: Directly interacts with SQL Server database via Entity Framework.
o	Service Layer: Business logic and data manipulation.
o	Core Layer: Entity models and DTOs (Data Transfer Objects).
o	API Layer: Exposes RESTful endpoints to interact with the frontend.
...
o	Navigate to the API project directory.
o	Restore dependencies:
3.	dotnet restore
o	Apply the database migrations:
...
8.	npm install
o	Start the Angular development server:
9.	ng serve
